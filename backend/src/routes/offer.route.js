...
import { createOffer, deleteOffer, getOffers, validateOffer } from "../controllers/offer.controller.js"
...
router.route("/:resid/offer/validate").post(verifyJWT, validateOffer)
